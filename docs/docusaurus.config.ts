...
const config: Config = {
  title: 'Nexus',
  tagline: 'Connect to any API service using a single interface',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/your-organization/nexus',
          label: 'GitHub',
          position: 'right',
        },
      ],
          ...
          items: [
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/nexus-api',
            },
            {
              label: 'GitHub Discussions',
              href: 'https://github.com/your-organization/nexus/discussions',
            },
          ],
        },
        {
